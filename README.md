...
| compressVideoPreset (ios only)          |      string (default MediumQuality) LowQuality, HighestQuality, Passthrough, 640x480, 960x540, 1280x720, 1920x1080      | Choose which preset will be used for video compression |
